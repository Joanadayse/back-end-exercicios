...
import { CreateCoursesSchema } from "../dtos/createCourses.dto"
import { ZodError } from "zod"
import { EditCoursesSchema } from "../dtos/editCourses.dto"
...
export class CourseController {
  ...
  public createCourse = async (req: Request, res: Response) => {
    try {
      ...
      const input = CreateCoursesSchema.parse( {
        id: req.body.id,
        name: req.body.name,
  ...
  public editCourse = async (req: Request, res: Response) => {
    try {
      ...
      const input =  EditCoursesSchema.parse({
